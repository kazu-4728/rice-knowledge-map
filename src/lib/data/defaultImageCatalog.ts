...
// 2026-07-12にapp-defaultsバケットへ配置済み）
const HERO_FAMILY_LEVEE = defaultImage("hero-family-levee.webp"); // 家族が畦道でスマホを見る、ワイド構図
const BANNER_MAP_AERIAL = defaultImage("banner-map-aerial.webp"); // 田園の空撮
const BANNER_RECORD_DESK = defaultImage("banner-record-desk.webp"); // カメラ・ICレコーダー・ノートの卓上
const BANNER_FAMILY_LEVEE = defaultImage("banner-family-levee.webp"); // 家族が畦道でスマホを見ている
const BANNER_GROWTH_COMPARE = defaultImage("banner-growth-compare.webp"); // 田植え直後と収穫期の対比
const BANNER_LINE_SHARE = defaultImage("banner-line-share.webp"); // 田んぼの写真がLINEで共有されている手持ちスマホ
