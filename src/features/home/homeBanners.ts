...
export const HOME_BANNERS: HomeBannerDef[] = [
  {
    ...
    detail: [
      ...
      {
        label: "その後どうなる?",
        items: ["登録した田んぼに記録を残せる", "異常はその場で報告できる", "記録タイムラインと履歴に反映される"],
      },
    ],
  ...
  },
  {
    ...
    summary: "写真・音声・作業内容を田んぼごとに残します。記録は記録タイムラインと田んぼの履歴に反映されます。",
    detail: [
      {
        label: "できること",
      ...
      {
        label: "その後どうなる?",
        items: ["記録が記録タイムラインに流れる", "仲間がすぐに確認できる", "田んぼの履歴に積み上がる"],
      },
    ],
  ...
  },
  {
    ...
    detail: [
      {
        label: "できること",
        items: ["記録タイムラインで時系列に確認", "田んぼの名札で絞り込み", "コメントで反応を返せる"],
      },
      {
        label: "使うタイミング",
  ...
  },
  {
    ...
    detail: [
      {
        label: "できること",
        items: ["田んぼごとの今の状態を確認", "その田んぼの記録だけを見る", "過去と今の写真を見比べる"],
      },
      {
        label: "使うタイミング",
        items: ["特定の田んぼの様子を知りたいとき", "季節の節目に", "去年と比べたいとき"],
      },
      {
        label: "その後どうなる?",
