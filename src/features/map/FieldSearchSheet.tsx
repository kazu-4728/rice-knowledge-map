        ...
        <div className="flex flex-col rounded-t-3xl glass-light-strong px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-2">
          ...
          {anonMode ? (
            <a
              ...
              className="flex shrink-0 items-center justify-between rounded-xl bg-emerald-500 px-4 py-3.5 text-white transition-colors hover:bg-emerald-600"
            >
              <div>
            ...
            <div className="shrink-0">
              ...
              <button
                ...
                className="mt-3 w-full rounded-xl bg-emerald-500 py-3.5 text-sm font-bold text-white transition-colors hover:bg-emerald-600"
              >
                田んぼを登録する
              </button>
            </div>
            ...
            <>
              {n === 0 ? (
                ...
                <div className="relative" style={{ height: VIEWPORT_H }}>
                  {/* 中央ハイライトバー */}
                  <div
                    className="pointer-events-none absolute inset-x-2 z-10 rounded-xl border border-emerald-400/40 bg-emerald-400/10"
