...
| ID | 状態 | 担当 | タスク | 完了条件 |
|---|---|---|---|---|
| T-010 | TODO | Claude Code | メインマップ画面を参照モック画像に近づける | スクショで参照画像と比較できる |
| T-011 | TODO | Claude Code | ヘッダーを軽くする | 地図の主役感を邪魔しない |
| T-012 | TODO | Claude Code | 下部ボトムシートを整える | スマホアプリらしく見える |
| T-013 | TODO | Claude Code | フローティング操作を整える | 写真で記録 / 音声メモ導線が分かる |
| T-014 | TODO | Claude Code | 地図上のピンとラベルを整理する | ラベル過多にならず、地点種別が分かる |
...
| ID | 状態 | 担当 | タスク | 完了条件 |
|---|---|---|---|---|
| T-020 | TODO | Claude Code | 写真で記録画面 | 写真、位置、田んぼ候補、音声追加導線がある |
| T-021 | TODO | Claude Code | 音声メモ画面 | 録音開始/停止/再生のUIがある |
| T-022 | TODO | Claude Code | 保存前確認画面 | AI整理結果を確認できる想定UIがある |
| T-023 | TODO | Claude Code | 記録詳細画面 | 写真、地図位置、コメント、状態操作が見える |
